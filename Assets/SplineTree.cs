...
{
	// figure out if branchstarter really do need to exist
	// the Nodelist
	[SerializeField]
	public List<SplineNode> branches = new List<SplineNode>();
	public List<int> branchStarter = new List<int>();

	// for the controll poitns, this however has to be adapted in the future
	[SerializeField] 
	...
	// The list of clusters in the tree, these are the objects the LSystem operates on 
